...
def show_risk_settings():
    ...
    print("Demo order execution: GUARDED")
    print("Real-account execution: BLOCKED")
    print()
    print("Default symbol:", DEFAULT_SYMBOL)
    print("Risk per trade:", DEFAULT_RISK_PERCENT, "%")
    print("Maximum lot size:", DEFAULT_MAX_LOT)
    print("First demo maximum lot:", FIRST_DEMO_MAX_LOT)
    print("Required stop-loss:", DEFAULT_STOP_LOSS_POINTS, "points")
    print()

    print("Safety rules:")
    print("\u2713 Demo account and execution environment are verified")
    print("\u2713 Demo execution requires explicit arming")
    print("\u2713 First demo order size is capped")
    print("\u2713 Fresh market activity is required before execution")
    print("\u2713 Open and closed positions are verified after execution")
    print("\u2713 Real-account execution is blocked")
    print()
